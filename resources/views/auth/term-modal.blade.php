<div class="modal fade term_modal" id="term_modal" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
...
<!-- Privacy -->
<div class="modal fade term_modal" id="privacy_modal" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered modal-xl" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel"></h5>
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12">
						...
						<div>
							<span>At INEX, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by INEX and how we use it.</span>
						</div>
						<div>
							<h6 class='mt-2'>Log Files</h6>
							<span>INEX follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies do this and a part of hosting services' analytics. The information collected by log files include internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks. These are not linked to any information that is personally identifiable. The purpose of the information is for analyzing trends, administering the site, tracking users' movement on the website, and gathering demographic information.</span>
                            <h6 class='mt-2'>Cookies, Pixels, and Local Storage</h6>
                            <span><strong>Cookies</strong> are used to store information including visitors' preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users' experience by customizing our web page content based on visitors' browser type and/or other information.</span><br>
                            <span><strong>Pixels</strong> are small amounts of code placed on a web page, in a web-enabled app, or an email. We use pixels to learn whether you've interacted with specific web or email content. This helps us measure and improve our services and personalize your experience, including the ads and content you see.</span><br>
                            <span>Local Storage is saving data on your computer or mobile device. We use it to turn on web navigation, customize what we show you based on your past interactions with our services, and remember your preferences.</span><br>
                            <span>Cookies are also used to operate our services, which include our websites, applications, APIs, pixels, embeds, and email communications. Specifically, INEX uses these technologies to:</span><br>
                            <ul>
                                <li>Keep you logged in to INEX.</li>
                                <li>Deliver features and functionality of INEX services.</li>
                            ...
                            <h6 class='mt-2'>Privacy Policies</h6>
                            <span>INEX has no advertising partners.</span></br>
                            <h6 class='mt-2'>Children's Information</h6>
                            <span>Another part of our priority is protection for children while using the internet. We encourage parents and guardians to observe, participate in, and/or monitor and guide their online activity.</span></br>
                            <span>INEX does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our best efforts to promptly remove such images or information from our records.</span></br>
                            <h6 class='mt-2'>Consent</h6>
                            <span>By using our website, you hereby consent to our Privacy Policy and agree to its Terms and Conditions.</span><br>
					    </div>
					</div>
				</div>
			</div>
...
<button type="button" class="btn btn-primary btn-trust" data-toggle="modal" data-target="#trustModal" style="display:none"></button>

<!-- Modal-->
<div class="modal fade" id="trustModal" tabindex="-1" role="dialog" aria-labelledby="trustModal" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content bg-white">
			...
			@else
				<div class="modal-header border-0">
					<h2 class="modal-title font-size-h2 text-dark" id="trustModal">What is a Trusted Agent?</h2>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<i aria-hidden="true" class="ki ki-close"></i>
					</button>
				</div>
				<div class="modal-body border-0">
					<span class="text-dark font-size-h3">A Trusted Agent is a client who does not need to get approval from INEX for every Ad it posts on the billboards.   A Trusted Agent can upload Ads, change their Playlist, and Manage their own Campaigns.<br><br>
					To become a Trusted Agent, you register your company.  Then INEX verifies you are bona fide company.   Once we approve your status, your account will be activated, allowing you to advertise when ever you wish - for as little as one day.</span>
				</div>
				<div class="modal-footer border-0">
					<button type="button" class="btn btn-primary font-weight-bold" data-dismiss="modal">Got It</button>
				</div>
...
$fc_content = [
	"home" => "Our clients do not need to get approval from INEX for every Ad you post on the billboards. You may upload Ads, change your Playlist, and Manage your own Campaigns.<br><br>
	Register your company here for free.   INEX will verify you are bona fide company.  We then activate your account.  Once activated, you may advertise whenever you wish.",
	"why-use-outdoor" => "Introducing no long term contracts to advertising.<br>
		Advertise for just one day if you want. <br>
		Display multiple Ads at no extra cost.  <br>
		Instantly change Ads 24/7.",
];
$fc_list = [
	"home" => 0,
	"why-use-outdoor" => 6,
...
?>
<button type="button" class="btn btn-primary btn-fc" data-toggle="modal" data-target="#fcModal" style="display:none"></button>
<!-- Modal-->
<div class="modal fade" id="fcModal" tabindex="-1" role="dialog" aria-labelledby="trustModal" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content bg-white">
			...
			$exist_pa = false;
			$pa_attach = "";
			if(isset($pa) && isset($fc_list[$route_name])){
				foreach($pa as $item){
					if($item->page_id == $fc_list[$route_name]){
						$exist_pa = true;
						$pa_attach = $item->attachment;
					}
				}
			...
			@else
				<div class="modal-header border-0">
					<h3 class="modal-title font-size-h2 text-dark" id="trustModal">NO ONE ELSE OFFERS OUR CAPABILITIES</h3>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<i aria-hidden="true" class="ki ki-close"></i>
					</button>
				</div>
				<div class="modal-body border-0">
					<span class="text-dark font-size-h3">
						<?php echo isset($fc_content[$route_name])?$fc_content[$route_name]:''?>
					</span>
				</div>
				<div class="modal-footer border-0">
					<button type="button" class="btn btn-primary font-weight-bold border-0" data-dismiss="modal">Got It</button>
				</div>
			@endif
        </div>
    </div>
