    ...
    <div class="subheader py-2 py-lg-12  subheader-transparent" id="kt_subheader"
        ...
        <div class="row w-100 m-0 sub-body">
            <div class="col-md-12 mb-5">
                <button class="btn btn-success" style="float:right" id="transfer">Transfer Funds to my Bank</button>
            </div>
            <?php
                $today = date("Y-m-d");
                // Last payment
                ...
                // on hold
                $total_hold = 0;
                if(session('level')==3 && isset($revenue->france)){
                    $com_rate = $revenue->france;
                }
            ...
            <div class="col-xl-4">
                <div class="card card-custom bg-light-danger card-stretch gutter-b">
                    <div class="card-body">
                        ...
                        <span
                            class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-6 d-block">${{number_format($total, 2)}}</span>
                            ...
                            <table class="table table-bordered table-hover table-checkable" id="kt_datatable">
                                ...
                                @foreach($invoices as $key => $val)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{isset($temp['location_name'])?$temp['location_name']:$temp['item']}}</td>
                                            <?php
                                                $weeks = $val['weeks'];
                                                if($val->status != 1){
                                                    $weeks = $val['paid'];
                                        ...
                                        <td>
                                            <?php
                                                    $avaialbe = true;
                                                    echo $avaialbe==true?'<span class="label label-xl label-primary label-inline mr-2">Avaiable</span>':
                                                    '<span class="label label-xl label-danger label-inline mr-2">On Hold</span>'?>
                                        </td>
                                    </tr>
                                    @endif
                                @endforeach
