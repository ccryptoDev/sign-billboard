...
<link type="text/css" rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jsgrid/1.5.3/jsgrid-theme.min.css" />                    
                        ...
                        <div class="card card-custom" data-card="true" id="kt_card_1">
                            <div class="card-header">
                                ...
                                <div class="card-toolbar">
                                    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-plus"></i>New Sales</button>
                ...
                <form id="new_sales">
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="sales_name" type="text" required >
                        </div>
                    </div>
    ...
    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#update_modal" id="btn_update" style="display: none"><i class="fa fa-plus"></i>New Sales</button>
    <div class="modal fade" id="update_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="update_sales">
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Sales Name</label>
                            <input class="form-control" name="tbl_id" id="u_id" type="hidden" value="">
                            <input class="form-control" name="sales_name" id="sales_name" type="text" value="" required>
                        </div>
                    </div>
                    <div class="modal-footer">
    ...
    <script>
        ...
        $("#new_sales").submit(function(event) {
            event.preventDefault();
            var fs =  new FormData(document.getElementById("new_sales"));
            $.ajax({
                url : "/new_sales",
                type : "POST",
                data : fs,
                ...
                success : function(res){
                    if(res == "success"){
                        $("#c_modal").click();
                        success_noti();
                        $("#new_sales").find("input").each(function(){
                            $(this).val("");
                        })
                    }
                    else{
        ...
        $("#update_sales").submit(function(event) {
            event.preventDefault();
            var fs =  new FormData(document.getElementById("update_sales"));
            $.ajax({
                url : "/update_sales",
                type : "POST",
                data : fs,
        ...
        $("#basicScenario").jsGrid({
            ...
            rowClick: function(args) { 
                ...
                if($(args.event.target)[0].className == 'fa fa-edit'){
                    ...
                    $("#sales_name").val(args.item.sales_name);
                    $("#btn_update").click();
                }
            ...
            fields: [
                ...
                { title: "Sales Name", name: "sales_name", type: "text", width: "150px",align: "left",editing: false},
