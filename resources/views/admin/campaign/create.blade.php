                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-9 my-2">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            ?>
                                            <div class="col-md-9">
                                                <input class="form-control form-control-lg form-control-solid" type="text" value="{{old('name')?old('name'):''}}" name="camp_name" required/>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-form-label col-md-3 text-lg-right text-left">Campaign Start Date
                                                <i class="far fa-question-circle text-danger" 
                                                    ...
                                                    data-content="Regardless of when you upload your Ads or Publish them, the Campaign Manager Start Date controls WHEN those ads and playlists get delivered to the signs. The Start Date must be today or in the future. "
                                                ></i>
                                            </label>
                                            <div class="col-md-3">
                                                <input class="form-control form-control-lg form-control-solid camp_start" type="date" min="{{date('Y-m-d')}}" value="{{old('camp_start')?old('camp_start'):date('Y-m-d')}}" name="camp_start" required/>
                                            </div>
                                        </div>
                                        <div class="form-group row" id="no_end_div">
                                            ...
                                            <div class="col-md-3 mb-5">
                                                <input class="form-control form-control-lg form-control-solid num_weeks" name="num_weeks" type="number" min="0" max="52" value="{{old('num_weeks')?old('num_weeks'):1}}" required/>
                                            </div>
                                            <label class="col-form-label col-md-3 text-lg-right text-left">Campaign End Date</label>
                                            <div class="col-md-3">
                                                <input class="form-control form-control-lg form-control-solid camp_end" disabled name="camp_end" type="date" min='{{date("Y-m-d", strtotime("+6 days"))}}' value='{{old("camp_end")?old("camp_end"):date("Y-m-d", strtotime("+6 days"))}}' name="camp_end" required/>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-12" data-scroll="true" data-wheel-propagation="true">
                                                <!-- <div class="checkbox-inline" id="locations"> -->
                                                <table class="table table-bordered table-hover table-checkable" id="kt_datatable">
                                                    ...
                                                    @foreach($locations as $key => $val)
                                                        <tr>
                                                            <td>
                                                                <label class="checkbox">
                                                                    <input type="checkbox" class="signs" 
                                                                        {{isset($ava_locations[$val->location_id])&&$ava_locations[$val->location_id]['num']==0?'':'checked'}} 
                                                                        {{isset($ava_locations[$val->location_id])&&$ava_locations[$val->location_id]['num']==0?'disabled':''}} 
                                                                        name="signs"/>
                                                                    <span></span>
                                                                </label>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <select class="form-control slot" autocomplete="off">
                                            ...
                                            <div class="col-5">
                                                <table class="w-100">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input id="dis_week" class="form-control text-right" value="1" disabled>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input class="form-control text-right coupon_number" value="{{$coupons[0]->id + 10000000}}" disabled/>
                                                        </td>
                                                    </tr>
                                                    @endif
                                                    <tr>
                            ...
                            <div class="card-footer">
                                <div class="row">
                                    ...
                                    <div class="col-xl-9">
                                        ...
                                        <button class="btn btn-info float-right save-draft ml-3" type="button">Save Campaign for Later</button>
                                        @if(session('level') < 2)
                                            @if(in_array('0', $payment_method))
                                                <button class="btn btn-danger float-right" type="submit">Save Campaign - No Charge</button>
                                            @else
                                                <button class="btn btn-primary float-right chose-payment" type="button">Choose Payment Method</button>
                                            @endif
                                        @else
                                        <button class="btn btn-danger float-right" type="submit">Save Campaign</button>
                                        @endif
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group mt-5">
                    <input class="form-control input-mask amount" id="part_amount" placeholder="Amount" data-inputmask-alias="currency" disabled>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-light-primary font-weight-bold" data-dismiss="modal">Close</button>
...
<script>
    function display_total(){
        ...
        $("#dis_dis").val("$ -" + (def - sub));
        $("#dis_total").val("$ " + sub )
        $("#total_amount").val(sub * $(".num_weeks").val());
        get_payment_method();
    }
    ...
    $(document).ready(function(){
        ...
        $(".signs, .days, .slot").on("change", function(){
            get_price();
        })
