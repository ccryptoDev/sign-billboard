                            ...
                            <form id="frmNew">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="date" type="date" value="{{date('Y-m-d')}}" min="{{date('Y-m-d')}}" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="auth_name" type="text" value="{{session('user_name')}}" disabled required autocomplete="off">
                                    </div>
                                    <div class="form-group">
