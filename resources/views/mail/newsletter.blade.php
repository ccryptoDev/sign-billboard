...
<head>
	...
	<style type="text/css" media="screen">
		body { padding:0 !important; margin:0 auto !important; display:block !important; min-width:100% !important; width:100% !important; background:#ecf7fa; -webkit-text-size-adjust:none }
		...
		.l-pink a { color: #004289; }
		.l-grey a { color: #6e6e6e; }
		.l-purple a { color: #9128df; }

		.gradient { background: linear-gradient(to right, #9028df 0%,#004289 100%); }

		.btn-secondary { border-radius: 10px; background: linear-gradient(to right, #9028df 0%,#004289 100%); }
...
<body class="body" style="padding:0 !important; margin:0 auto !important; display:block !important; min-width:100% !important; width:100% !important; background:#ecf7fa; -webkit-text-size-adjust:none;">
	<center>
		<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin: 0; padding: 0; width: 100%; height: 100%;" bgcolor="#ecf7fa" class="gwfw">
			<tr>
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td class="title-16 a-center pb-15" style="font-size:16px; line-height:40px; color:#282828; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; text-align:center; padding-bottom: 15px;">
															<strong>Information Useful For Your Business</strong>
														</td>
													</tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td class="text-16 lh-26 a-left pb-25" style="font-size:16px; color:#6e6e6e; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 26px; text-align:left; padding-bottom: 25px;">
                                                            <br>
															You are receiving this e-mail because you are a either a client of INEX, downloaded one or more of our free documents about marketing or advertising, or have some form of a business relationship with us. <br><br>
															If you no longer wish to receive this e-mail, you can cancel or modify your subscription here: <a href="{{ config('app.url') }}/unsubscribe">Unsubscribe.</a><br><br>
															INEX welcomes comments or suggestions at <a href="mailto:support@inex.net">support@inex.net</a>. This address is for feedback only. <br><br>
															© {{date('Y')}} Information Exchange Network, Inc. All rights reserved. Any reproduction, copying, or redistribution, in whole or in part, is prohibited without written permission from Information Exchange Network, Inc.
