    ...
    <nav class="navbar navbar-expand-lg transparent-bg static-nav">
        <div class="container">
            <a class="navbar-brand" href="/" style="width:100%;max-width:200px">
                <img src="/logo.png" alt="logo" class="logo-default" style='max-width:100%;height:50px'>
            ...
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        <span class="nav-link dropdown-toggle" id="navbarDropdownMenuLink">
                            <a href="/bill_ad">Digital Billboard Advertising</a>
                        </span>
                        <ul class="dropdown-menu">
                            <li><a href="/why-use-outdoor">Why use INEX Billboards?</a></li>
                            <li><a href="/register">Become a Trusted Agent</a></li>
                            <li><a href="/our_location">Locations / Pricing</a></li>
                            <li><a href="/img/INEX_Media_Kit.pdf" target="_blank">Download Media Kit</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
