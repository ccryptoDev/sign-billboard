        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <div class="page-titles whitecolor text-center padding_top padding_bottom">
                    <h2 class="font-bold  padding_top">Digital Billboard Advertising Space El Reno, Oklahoma</h2>
    ...
    <div class="container aboutus">
	    <div class="row">
            <div class="col-md-12 text-center heading_space wow fadeIn" data-wow-delay="300ms">
                <h2 class="heading bottom30 darkcolor font-light2"><span class="font-weight-light">Digital Billboard Advertising Space El Reno Oklahoma .</span>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-6 padding_bottom_half">
                <div class="image"><img alt="SEO" src="/img/half-790x1024.jpg"></div>
            </div>
