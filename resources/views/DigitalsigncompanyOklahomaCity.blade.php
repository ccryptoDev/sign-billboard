...
h4.darkcolor.font-xlight.text-center.fontw {
    font-weight: 300;
}
.row.align-items-top .image {
    margin-top: 55px;
}
.image.margintop img {
    margin-top: 80px;
        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <div class="page-titles whitecolor text-center padding_top padding_bottom">
                    <h2 class="font-bold  padding_top">Digital Sign Company Oklahoma City</h2>
        ...
        <div class="gradient-bg title-wrap mt-n5">
            <div class="row">
                <div class="col-lg-12 col-md-12 whitecolor">
                    <h3 class="float-left">SCHEDULE A FREE CONSULTATION</h3>
    ...
    <div class="container aboutus">
	    <div class="row">
            <div class="col-md-12 text-center heading_space wow fadeIn" data-wow-delay="300ms">
                <h2 class="heading bottom30 darkcolor font-light2"><span class="font-weight-light"> Digital Sign Company Oklahoma City </span>
        ...
        <div class="row align-items-top">
            <div class="col-lg-6 col-md-6 padding_bottom_half">
                <div class="image"><img alt="SEO" src="/img/landingimage2.png"></div>
                <div class="image margintop"><img alt="SEO" src="/img/landingrevised.jpeg"></div>

            </div>
            <div class="col-lg-5 offset-lg-1 col-md-6 padding_bottom_half text-center text-md-left">
                <h2 class="darkcolor font-normal bottom30"><span class="defaultcolor">What is Lorem Ipsum?</span> </h2>
                <p class="bottom5">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry’s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
                    <br><h2 class="darkcolor font-normal bottom30"><span class="defaultcolor">What is Lorem Ipsum?</span> </h2>
                <p class="bottom5">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry’s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
            
                  <br><h2 class="darkcolor font-normal bottom30"><span class="defaultcolor">Where does it come from?</span> </h2>
                <p class="bottom5">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry’s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
...
<div class="gradient-bg title-wrap mt-n5" style="height:180px">
            <div class="row">
                <div class="col-lg-12 col-md-12 whitecolor">
                    <h1 class="text-center"style="margin-top:60px">SCHEDULE A FREE CONSULTATION</h1>
                 </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 order-sm-2">
                    <div class="contact-meta px-2 text-center text-md-left">
                        ...
                        <p class="bottom10"><a href="mailto:polpo@traxagency.co.au">sales@inex.net</a></p>
                        <p class="bottom10">Mon-Fri: 9am-5pm</p>
                        <ul class="social-icons mt-4 mb-4 mb-sm-0 wow fadeInUp" data-wow-delay="300ms">
                            <li><a href="https://www.facebook.com/Digital-Signs-107309900997274/?modal=admin_todo_tour"><i class="fab fa-facebook-f"></i> </a> </li>
                            ...
                            <li><a href="https://www.instagram.com/latenser11/"><i class="fab fa-instagram"></i> </a> </li>
                        </ul>
                    </div>
                </div>
